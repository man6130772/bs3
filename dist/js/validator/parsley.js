...
(function (global, factory) {
  ...
  var typeRegexes = $.extend(true, {}, {
    ...
    // resource path
    "(?:/\\S*)?" + "$", 'i')
  }, window.ParsleyConfig.typeRegexes || {});
  ...
  window.ParsleyConfig = $.extend(true, {},  Parsley.options, window.ParsleyConfig || {}); // Old way of accessing global options
  ...
  Parsley.addMessages('ch', {
    defaultMessage: "无效值，请重新输入..",
    type: {
      email: "这是无效的email地址，请重新输入..",
      url: "这是无效的url地址，请重新输入..",
      number: "这是无效的数值，请重新输入..",
      integer: "请输入整形数值..",
      digits: "请输入正整数..",
      alphanum: "请输入字母或数字.."
    },
    notblank: "此处不能为空，请重新输入..",
    required: "此为必需项，请重新输入..",
    pattern: "该值不符合要求，请重新输入..",
    min: "该值应该大于或等于 %s，请重新输入..",
    max: "该值应该小于或等于 %s，请重新输入..",
    range: "该值应该在 %s 和 %s 之间，请重新输入..",
    minlength: "该值长度太短，应该大于或等于 %s 个字符，请重新输入..",
    maxlength: "该值长度太长. 应该少于或等于 %s 个字符，请重新输入..",
    length: "无效值. 该值长度应该在 %s 和 %s 个字符之间，请重新输入..",
    mincheck: "必须选择至少 %s 个选项..",
    maxcheck: "只能选择最多 %s 个选项..",
    check: "只能选择 %s 到 %s 个选项..",
    equalto: "该值必须相等，请重新输入.."
  });

  // Parsley.setLocale('en');
  Parsley.setLocale('ch');
